...
match priority:
    case "high":
        ...
        if time_bound == "no":
            print(f"Reminder: '{task}' is a high priority task but doesn't require immediate action")
    case "medium":
        if time_bound == "yes":
    ...
    case "low":
        ...
        if time_bound == "no":
            print(f"Note: '{task}' is a low priority task but doesn't require immediate action")